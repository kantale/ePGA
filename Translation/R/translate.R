...
# This runs the first time and builds the files in the output directory.
# Since its had;y ever possible to have to revuild these files I (kantale) have
# commented it out. To rebuild these files simply remove the if False clause 
if (F) {
